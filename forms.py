...
class ArticleCreateForm(FlaskForm):
    ...
    content_type = SelectField(
        "Тип контента", 
        coerce=str, 
        choices=list(article_type_dict.items()),
...
class ArticleEditForm(FlaskForm):
    ...
    status = SelectField(
        "Статус", 
        coerce=str, 
        choices=list(article_status_dict.items()),
        validators=[DataRequired()]
    )
